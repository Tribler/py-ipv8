...
from .cryptosystem.boneh import generate_keypair
from .structs import BitPairAttestation, BonehPrivateKey, BonehPublicKey, pack_pair, unpack_pair
...
class BonehAttestation(Attestation):
    ...
    def __init__(self, PK, bitpairs, id_format):
