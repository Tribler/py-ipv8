...
class TestCommunity(TestBase):
    ...
    private_key = BonehPrivateKey.unserialize(bytes.fromhex("01064c65dcb113f901064228da3ea57101064793a4f9c77901062b083e8690fb0" +
                                               "106408293c67e9f010601d1a9d3744901030f4243"))
    ...
    def test_verify_attestation(self):
        ...
        with open(filename, 'r') as f:
            serialized = bytes.fromhex(f.read().strip())
        attestation = Attestation.unserialize(serialized)
        attestation_hash = bytes.fromhex('9019195eb75c07ec3e86a62c314dcf5ef2bbcc0d')
