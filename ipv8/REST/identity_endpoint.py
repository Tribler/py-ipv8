...
if TYPE_CHECKING:
    ...
    from aiohttp.web_request import Application, Request
...
class IdentityEndpoint(BaseEndpoint[IPv8]):
    ...
    @docs(
        tags=["Identity"],
        summary="List the outstanding requests for attestations by others.",
        parameters=[{
            "in": "path",
            "name": "pseudonym_name",
            "description": "The name of the pseudonym to use.",
    ...
    async def list_pseudonym_outstanding_attestations(self, request: Request) -> Response:
        """
        List the outstanding requests for attestations by others.
        """
        if self.communication_manager is None:
    ...
    @docs(
        tags=["Identity"],
        summary="List the outstanding requests for verification by others.",
        parameters=[{
            "in": "path",
            "name": "pseudonym_name",
            "description": "The name of the pseudonym to use.",
    ...
    async def list_pseudonym_outstanding_verifications(self, request: Request) -> Response:
        """
        List the outstanding requests for verification by others.
        """
        if self.communication_manager is None:
            return Response({"requests": []})
        self.communication_manager = cast("CommunicationManager", self.communication_manager)
