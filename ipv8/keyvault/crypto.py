...
from .private.openssl import OpenSSLSK
from .public.openssl import OpenSSLPK
...
class ECCrypto:
    ...
    def generate_key(self, security_level: str) -> PrivateKey:
        ...
        if security_level in _CURVES:
            curve_name = _CURVES.get(security_level, security_level)
            return OpenSSLSK.generate(curve_name)
