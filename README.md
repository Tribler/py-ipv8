...
**Linux**: [![](http://jenkins.tribler.org/job/ipv8/job/test_ipv8/badge/icon)](http://jenkins.tribler.org/job/ipv8/job/test_ipv8/) **Windows**: [![](http://jenkins.tribler.org/job/ipv8/job/test_ipv8_unittests_windows/badge/icon)](http://jenkins.tribler.org/job/ipv8/job/test_ipv8_unittests_windows/) **Mac**: [![](http://jenkins.tribler.org/job/ipv8/job/test_ipv8_unittests_mac/badge/icon)](http://jenkins.tribler.org/job/ipv8/job/test_ipv8_unittests_mac/)
